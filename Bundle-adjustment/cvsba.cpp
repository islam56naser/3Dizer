...
namespace cvsba {
    ...
    double  Sba::run ( std::vector<cv::Point3f>& points, //positions of points in global coordinate system (input and output)
					   ...
					   const int mConst //number of constant cameras
                     )  throw ( cv::Exception ) {
        ...
        double err=run ( points_d,imagePoints_d,visibility,cameraMatrix,R,T,distCoeffs,mConst );
